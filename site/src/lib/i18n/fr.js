...
export const LOCALES = {
  fr: {
    ...
    paletteHints: { classique: "Neutre, accent pétrole", pop: "Turquoise et citron", lagune: "Eau claire",
                    riso: "Pétrole et corail", sepia: "Lecture longue", contraste: "AAA, traits pleins" },
